...
class AuthIntegrationTest {
    ...
    void shouldRegisterUserSuccessfully() throws Exception {
        AuthDto.RegisterRequest request = new AuthDto.RegisterRequest("Test User", "test@example.com", "password123");
    ...
    void shouldLoginSuccessfully() throws Exception {
        // Create user
        AuthDto.RegisterRequest registerRequest = new AuthDto.RegisterRequest("Login User", "login@example.com", "password123");
        mockMvc.perform(post("/auth/register")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void shouldAccessSecuredEndpointWithToken() throws Exception {
        ...
        AuthDto.RegisterRequest request = new AuthDto.RegisterRequest("Secured User", "secured@example.com", "password123");
